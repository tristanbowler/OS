 ...
 *    Modified by Tristan Bowler for CS 5460 at the U of U
 *
...
{
    printk(KERN_INFO "Loading my-module, which was written by Trisan Bowler.\n");
    return 0;	// Non-zero return means that the module couldn't be loaded.
}

static void __exit my_module_cleanup(void)
{
    printk(KERN_INFO "Unloading my-module, which was written by Tristan Bowler.\n");
}
